...
export const messages = {
  tr: {
    home: {
      ...
      launchTool: 'Aracı aç',
      toolsAria: 'Araçlar',
      contentTitle: 'Günlük Yardımcı Seti Nedir?',
      contentBody:
        'Günlük Yardımcı Seti; çekiliş, karar verme, zaman takibi, birim dönüştürme ve metin analizi gibi mini araçları tek bir yerde sunan tarayıcı tabanlı bir yardımcı platformdur. Tüm işlemler cihazınızda gerçekleşir.',
      howTitle: 'Nasıl Kullanılır?',
      how1: 'Ana sayfadan bir araç seçin.',
      how2: 'Gerekli alanları doldurun ve işlemi başlatın.',
      how3: 'Sonucu anında görün, isterseniz tekrar deneyin.',
      faqTitle: 'Sık Sorulan Sorular',
      faq1q: 'Verilerim saklanıyor mu?',
      faq1a:
        'Hayır. Araç kullanımı sırasında girilen veriler sunucuya gönderilmez; tarayıcı oturumunda işlenir.',
      faq2q: 'Ücretsiz mi?',
      faq2a: 'Evet. Tüm araçlar ücretsiz kullanılabilir.',
      faq3q: 'Mobilde çalışır mı?',
      faq3a:
        'Evet. Arayüz mobil, tablet ve masaüstü ekranlara uyumlu olarak tasarlanmıştır.',
    },
  ...
  en: {
    home: {
      ...
      toolsAria: 'Tools',
      contentTitle: 'What Is Daily Utility Toolkit?',
      contentBody:
        'Daily Utility Toolkit is a browser-based helper platform that bundles mini tools for raffles, decisions, timers, conversions, and text analysis in one place. All processing happens on your device.',
      howTitle: 'How To Use',
      how1: 'Pick a tool from the homepage.',
      how2: 'Fill the required fields and start the action.',
      how3: 'Get the result instantly and repeat if needed.',
      faqTitle: 'Frequently Asked Questions',
      faq1q: 'Is my data stored?',
      faq1a:
        'No. Input data is not sent to servers during tool usage; it is processed in your browser session.',
      faq2q: 'Is it free?',
      faq2a: 'Yes. All tools are available for free.',
      faq3q: 'Does it work on mobile?',
      faq3a:
        'Yes. The interface is designed to adapt to mobile, tablet, and desktop screens.',
    },
    shell: { home: 'Home' },
